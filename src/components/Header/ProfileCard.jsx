...
import { Globe, Mail, FileText, Check, ExternalLink } from 'lucide-react';
      ...
      <div>
        ...
        <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
          <div className="relative group mb-4">
            ...
            <div className="absolute -bottom-1 -right-1 bg-sky-600 text-white text-[11px] font-bold px-2 py-0.5 rounded-md shadow">
              PRO
            </div>
          </div>
        ...
        <div className="flex items-center justify-center sm:justify-start gap-2 flex-wrap">
          {profile.github && (
            <a
              ...
              className="p-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all"
              title="GitHub"
            >
              <GithubIcon size={18} />
            </a>
          ...
          <button
            ...
            className="p-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all relative"
            title="이메일 복사"
          >
          ...
          {profile.resumeUrl && (
            <a
              ...
              className="ml-auto inline-flex items-center gap-1 text-xs font-semibold px-3 py-2 rounded-xl bg-sky-600 hover:bg-sky-700 text-white transition-all shadow-sm shadow-sky-500/30"
            >
              <FileText size={14} />
              <span>이력서</span>
            </a>
